...
namespace krabka {
namespace {
constexpr std::string_view kSendPath = "/krabka.gateway.v1.Gateway/Send";
constexpr std::string_view kSubscribePath = "/krabka.gateway.v1.Gateway/Subscribe";
constexpr std::string_view kQueueAcquirePath = "/krabka.gateway.v1.Gateway/QueueAcquire";
constexpr std::string_view kQueueAcknowledgePath = "/krabka.gateway.v1.Gateway/QueueAcknowledge";
constexpr std::string_view kQueueRenewPath = "/krabka.gateway.v1.Gateway/QueueRenew";
...
std::optional<std::string> http2_parse_failure_message(ssize_t parsed) {
  ...
  return krabka::detail::http2_parse_failure_message(
