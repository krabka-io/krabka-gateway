...
impl KrabkaClient {
    ...
    #[must_use]
    pub fn builder() -> KrabkaClientBuilder {
        KrabkaClientBuilder::default()
    }
    ...
    /// # Errors
    ///
    /// Returns [`KrabkaError::InvalidArgument`] when required client
    /// configuration is missing.
    pub fn new(endpoint: impl Into<String>) -> Result<Self, KrabkaError> {
...
/// Builder for [`KrabkaClient`].
#[derive(Debug, Default)]
pub struct KrabkaClientBuilder {
    endpoint: Option<String>,
    bearer: Option<String>,
}

impl KrabkaClientBuilder {
    ...
    /// # Errors
    ///
    /// Returns [`KrabkaError::InvalidArgument`] when no endpoint was supplied.
    pub fn build(self) -> Result<KrabkaClient, KrabkaError> {
        let endpoint = self
            .endpoint
            .ok_or_else(|| KrabkaError::InvalidArgument("endpoint is required".into()))?;
        Ok(KrabkaClient {
